...
import { JuniorCollegeComponent } from './pages/cource/junior-college/junior-college.component';
import { PostGraduationComponent } from './pages/cource/post-graduation/post-graduation.component';
import { SeniorCollegeComponent } from './pages/cource/senior-college/senior-college.component';
import { UnderGraduationComponent } from './pages/cource/under-graduation/under-graduation.component';
import { VocationalCoursesComponent } from './pages/cource/vocational-courses/vocational-courses.component';
...
import { AboutSocityComponent } from './pages/society/about-socity/about-socity.component';
import { HistortSocietyComponent } from './pages/society/histort-society/histort-society.component';
import { InfrastructurComponent } from './pages/society/infrastructur/infrastructur.component';
import { VissionSocietyComponent } from './pages/society/vission-society/vission-society.component';
...
const routes: Routes = [
  ...
  {
    path: 'society',
    loadChildren: () => import('./pages/society/society.module').then(m => m.SocietyModule)
  },
  {
    path: 'team',
  ...
  // },
    ...
    { path: 'society/about-socity', component:  AboutSocityComponent },
    { path: 'society/history-society', component:  HistortSocietyComponent },
    { path: 'society/infrastructur', component:  InfrastructurComponent },
    { path: 'society/vission-society', component:  VissionSocietyComponent },

    { path: 'cource/junior-college', component:  JuniorCollegeComponent },
    { path: 'cource/post-graduation', component:  PostGraduationComponent },
    { path: 'cource/under-graduation', component:  UnderGraduationComponent },
    { path: 'cource/vocational-courses', component:  VocationalCoursesComponent },
